				...
				<TBODY>
									...
									<c:forEach var="u" items="${users}" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/editUser1/<c:out value="${u.uid }"/>">
													<img src="${pageContext.request.contextPath}/WEB-INF/images/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/deleteUser1/<c:out value="${u.uid }" />/<c:out value="${page }" />">
					...
					<tr align="center">
						<td colspan="7">
							...
							<c:if test="${page != 1 }">
								<a href="listUser1/1">首页</a>|
								<a href="${ pageContext.request.contextPath }/listUser1/<c:out value="${page - 1 }"/>">上一页</a>|
							</c:if>
							<c:if test="${page != count }">
								<a href="${ pageContext.request.contextPath }/listUser1/<c:out value="${page + 1 }"/>">下一页</a>|
								<a href="${ pageContext.request.contextPath }/listUser1/<c:out value="${count }"/>">尾页</a>|
							</c:if>
						</td>
					</tr>
				</TBODY>

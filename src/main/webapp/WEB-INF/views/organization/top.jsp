...
{document.write(myArray[weekday])
  ...
  function exit(){
       window.open('${pageContext.request.contextPath}/views/organization/index.jsp','_top')
         } 
									</script> </font>
							</td>
							<td width="15%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="155" valign="bottom"
											background="${pageContext.request.contextPath}/images/mis_05b.jpg">
											用户名：
											<font color="blue"><c:out value="${sessionScope.organization.organname}"></c:out></font>
											|

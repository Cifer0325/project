...
<body>
	<form:form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/updateOrganization"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colspan="3"><form:input
					type="text" path="organname" id="userAction_save_do_logonName" class="bg" /></td>
			</tr>
